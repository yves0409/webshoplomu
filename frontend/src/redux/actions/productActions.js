...
//////////////////DELETE PRODUCT////////////////////////////////////////
export const deleteListProduct = (id) => async (dispatch, getState) => {
  try {
    dispatch({
...
////////////////BEST RATED PRODUCTS/////////////////////////////
export const listBestRatedProducts = () => async (dispatch) => {
  try {
    dispatch({ type: PRODUCT_BEST_RATED_REQUEST });

    const { data } = await axios.get("/api/products/top");

    dispatch({ type: PRODUCT_BEST_RATED_SUCCESS, payload: data });
  } catch (error) {
    dispatch({
